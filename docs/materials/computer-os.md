...
本页用于整理计算机操作系统课程的学习资料。资料内容以同学贡献为主，仅供学习参考；课程范围、实验要求、作业要求和考试安排请以任课教师当学期说明为准。

## 资料目录

<MaterialResourceList course="computer-os" />
...
```text
docs/materials/computer-os.md
docs/public/materials/computer-os/
```
