...
本页用于整理线性代数课程的学习资料。资料内容以同学贡献为主，仅供学习参考；课程范围、实验要求、作业要求和考试安排请以任课教师当学期说明为准。

## 资料目录

<MaterialResourceList course="linear-algebra" />
...
```text
docs/materials/linear-algebra.md
docs/public/materials/linear-algebra/
```
