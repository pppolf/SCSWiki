---
title: Java Web应用开发资料
description: Java Web应用开发课程相关学习资料整理
category: materials
audience:
  - 学生
...
本页用于整理Java Web应用开发课程的学习资料。资料内容以同学贡献为主，仅供学习参考；课程范围、实验要求、作业要求和考试安排请以任课教师当学期说明为准。

## 资料目录

<MaterialResourceList course="javaweb" />
...
```text
docs/materials/javaweb.md
docs/public/materials/javaweb/
```
